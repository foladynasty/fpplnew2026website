              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-2 w-64 bg-white shadow-2xl rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 p-4 z-50">
                  <ul className="space-y-2">
                    ...
                    <li>
                      <a href="/testimonials" className="block text-gray-700 hover:text-gold transition-colors text-sm py-2">
                        Wall of Love ❤️
                      </a>
                    </li>
                  </ul>
                  ...
                  <div className="grid grid-cols-3 gap-8">
                    ...
                    <div>
                      ...
                      <ul className="space-y-3">
                        ...
                        <li>
                          <a href="/cfp?tab=schedule#study-options" className="text-gray-700 hover:text-primary-600 transition-colors text-sm">
                            Course Schedule
                          </a>
                        </li>
                        <li>
